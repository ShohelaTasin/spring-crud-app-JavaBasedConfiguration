...
public class UserDaoImpl implements UserDao {
    ...
    public void addUser(User user) {
        String sql = "INSERT INTO register.test (firstname, lastname, address) Values (:firstname, :lastname, :address)";
        namedParameterJdbcTemplate.update(sql, getSqlParameterByModel(user));
    }

    public void updateUser(User user) {
        String sql = "UPDATE register.test SET firstname = :firstname, lastname = :lastname, address = :address WHERE id = :id";

        namedParameterJdbcTemplate.update(sql, getSqlParameterByModel(user));
    }

    public void deleteUser(int id) {
        String sql = "DELETE FROM register.test  WHERE id = :id";

        namedParameterJdbcTemplate.update(sql, getSqlParameterByModel(new User(id)));
    }

    public User findUserById(int id) {
        String sql = "SELECT * FROM register.test  WHERE id = :id";
